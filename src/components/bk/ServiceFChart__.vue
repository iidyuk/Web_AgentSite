...
export default {
  ...
  beforeUpdate() {  // beforeUpdate() | データが変更され、DOMに反映される前
    ...
    // this.$store.getters['serv/test1Set'];
    // this.$store.commit['serv/beforeUp'];
    const test1 = 'aa';
    const newTagClass =[
      'aa',
      this.test2,
  ...
  //   // test1: {
  //   //   get() {
  //   //     return this.$store.state.serv.test1;
  //   //   },
  //   //   set(value) {
  //   //     this.$store.commit('serv/updateName', value);
  //   //   },
  //   // },
    test1() {
      return this.$store.getters['serv/test1Set'];
      // return this.$store.state.serv.test1;

    },
    test2() {
      return this.$store.getters['serv/test2Set'];
    },
    test3() {
      return this.$store.getters['serv/test3Set'];
    },
    test4() {
      return this.$store.getters['serv/test4Set'];
    },
    test5() {
      return this.$store.getters['serv/test5Set'];
    },
    checkedRabi: {
      get() {
        return this.$store.state.serv.checkedRadi;
      },
      set(value) {
        this.$store.commit('serv/upIsDome', value);
      }
    },
    isDomestic: {
      get() {
        return this.$store.state.serv.isDomestic;
      },
      set(value) {
        this.$store.commit('serv/upIsDome', value);
      },
    ...
    isAbroad: {
      get() {
        return this.$store.state.serv.isAbroad;
      },
      set(value) {
        this.$store.commit('serv/upIsAbroad', value);
      },
    },
    slidePosiLeft() {
      return this.$store.state.serv.slidePosiLeft;
    },
    slidePosiCenter() {
      return this.$store.state.serv.slidePosiCenter;
    },
    slidePosiRight() {
      return this.$store.state.serv.slidePosiRight;
    },
  },
  watch: {
  //   // ↓ domestic-abroad の表示切替処理
    workPattern(wp) {
      this.$store.dispatch('serv/workPattern', wp);
    //   // switch (wp) {
    //   //   case 'domestic':
  ...
  methods: {
    ...
    toggleBtn(n) {
      this.$store.commit('serv/toggleBtn', n);
      // switch (n) {
      //   case 1:
    ...
    prevBtn() {
      this.$store.commit['serv/beforeUp'];
      this.$store.dispatch('serv/prevBtn');
    ...
    nextBtn() {
      this.$store.dispatch('serv/nextBtn');
      // switch (this.checkedRadi) {
      //   case 'radio01':
      //     this.toggleBtn(2);
      //     this.checkedRadi = 'radio02';
